...
bool KallsymsLookupName_6_4_0::init() {
	...
	std::vector<size_t> maybe_kallsyms_num_offset = find_maybe_kallsyms_num(offset_list_start, offset_list_end);
...
uint64_t KallsymsLookupName_6_4_0::find_kallsyms_relative_base(size_t offset_list_end, size_t& kallsyms_relative_base_offset) {
	for (int i = 0; i < 5; i++) {
...
std::vector<size_t> KallsymsLookupName_6_4_0::find_maybe_kallsyms_num(size_t offset_list_start, size_t offset_list_end) {
	//Search upwards
	...
	for (int i = 0; i < 3; i++) {
		...
		size_t offset = (offset_list_end - offset_list_start) / sizeof(long);
		maybe_kallsyms_num.push_back(offset);
	}
...
bool KallsymsLookupName_6_4_0::find_kallsyms_sym_func_entry_offset(size_t& kallsyms_sym_func_entry_offset) {
