...
int KallsymsLookupName_6_1_42::find_kallsyms_num1(size_t offset_list_start, size_t offset_list_end, size_t kallsyms_relative_base_end_offset, size_t fuzzy_range, size_t& kallsyms_num_offset) {
...
int KallsymsLookupName_6_1_42::find_kallsyms_num2(size_t size, size_t kallsyms_relative_base_end_offset, size_t fuzzy_range, size_t& kallsyms_num_offset) {
	size_t allow_min_size = size - fuzzy_range;
	size_t allow_max_size = size + fuzzy_range;
	auto _min = MIN(m_file_buf.size(), MAX_FIND_RANGE);
	int cnt = 10;
