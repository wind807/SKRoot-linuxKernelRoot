...
KallsymsLookupName_6_1_0::KallsymsLookupName_6_1_0(const std::vector<char>& file_buf) : m_file_buf(file_buf)
{
}

KallsymsLookupName_6_1_0::~KallsymsLookupName_6_1_0()
{
}

bool KallsymsLookupName_6_1_0::init() {
...
bool KallsymsLookupName_6_1_0::is_inited() const {
	return m_inited;
}
...
bool KallsymsLookupName_6_1_0::find_kallsyms_offsets_list(size_t& start, size_t& end) {
...
bool KallsymsLookupName_6_1_0::find_kallsyms_markers_list(int kallsyms_num, size_t name_list_end_offset, size_t& markers_list_start, size_t& markers_list_end) {
...
bool KallsymsLookupName_6_1_0::find_kallsyms_token_table(size_t markers_list_end_offset, size_t& kallsyms_token_table_start, size_t& kallsyms_token_table_end) {
...
bool KallsymsLookupName_6_1_0::find_kallsyms_token_index(size_t kallsyms_token_table_end, size_t& kallsyms_token_index_start) {
...
bool KallsymsLookupName_6_1_0::resolve_kallsyms_addresses_symbol_base(size_t code_static_start, uint64_t& base_address) {
...
bool KallsymsLookupName_6_1_0::resolve_kallsyms_offset_symbol_base(size_t code_static_start, int& base_off) {
	if (!has_kallsyms_symbol("_stext")) {
		return false;
	}
	if (has_kallsyms_symbol("_text")) {
 ...
 */
unsigned int KallsymsLookupName_6_1_0::kallsyms_expand_symbol(unsigned int off, char* result, size_t maxlen)
{
...
uint64_t KallsymsLookupName_6_1_0::kallsyms_lookup_name(const char* name) {
...
uint64_t KallsymsLookupName_6_1_0::kallsyms_symbol_size(uint64_t cur_addr) {
...
std::unordered_map<std::string, uint64_t> KallsymsLookupName_6_1_0::kallsyms_on_each_symbol() {
...
bool KallsymsLookupName_6_1_0::has_kallsyms_symbol(const char* name) {
	std::unordered_map<std::string, uint64_t> syms = kallsyms_on_each_symbol();
	auto iter = syms.find(name);
