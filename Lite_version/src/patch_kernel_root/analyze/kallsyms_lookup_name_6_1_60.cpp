...
bool KallsymsLookupName_6_1_60::is_inited() const {
	return m_inited;
}
...
int KallsymsLookupName_6_1_60::find_kallsyms_num_by_names_logic(size_t start, int min_cnt, int max_cnt, size_t& kallsyms_num_offset) {
...
bool KallsymsLookupName_6_1_60::check_kallsyms_names_list_entropy(size_t start, size_t end, int kallsyms_num) {
...
uint64_t KallsymsLookupName_6_1_60::kallsyms_symbol_size(uint64_t cur_addr) {
