...
| 特性 / 版本 | 🟢 SkRoot (Lite) | 🚀 SkRoot (Pro) |
| :--- | :--- | :--- |
| **隐藏能力** | **完美隐藏 Root**、**SELinux 零触碰、无挂载** | **完美隐藏 Root**、**SELinux 零触碰、无挂载** |
| **定位** | 面向基础 Root 场景，稳定性最佳。 | 主力版本，拥有更强的控制能力。 |
| **核心能力** | 适用于基础 Root 需求。 | 支持 **授权管理** + **内核模块**。 |
| **进阶特性** | - | 隐藏目录、隐蔽执行sh、解除温控、系统文件无痕伪造等。 |
| **模块特性** | - | 支持内核热修改，最高 **10万Hook点位、0性能损耗**，单模块跨内核通用。 |
