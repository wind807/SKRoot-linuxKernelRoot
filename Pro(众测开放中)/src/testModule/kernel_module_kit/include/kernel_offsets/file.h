...
/***************************************************************************
* 获取 file 结构体中 unsigned int f_flags; 字段的偏移量
* 参数: offset      输出参数，返回 f_flags 字段相对于 file 起始的偏移量（字节）
* 返回: OK 表示成功；其它值为错误码
***************************************************************************/
KModErr get_file_f_flags_offset(uint32_t & offset);

/***************************************************************************
* 获取 file 结构体中 fmode_t f_mode; 字段的偏移量
* 参数: offset      输出参数，返回 f_mode 字段相对于 file 起始的偏移量（字节）
* 返回: OK 表示成功；其它值为错误码
***************************************************************************/
KModErr get_file_f_mode_offset(uint32_t & offset);

/***************************************************************************
* 获取 file 结构体中 loff_t f_pos; 字段的偏移量
* 参数: offset      输出参数，返回 f_pos 字段相对于 file 起始的偏移量（字节）
* 返回: OK 表示成功；其它值为错误码
***************************************************************************/
KModErr get_file_f_pos_offset(uint32_t & offset);
