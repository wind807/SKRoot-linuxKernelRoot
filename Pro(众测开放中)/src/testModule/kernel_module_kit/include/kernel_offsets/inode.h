...
/***************************************************************************
* 获取 inode 结构体中 i_mode 字段的偏移量
* 参数: offset      输出参数，返回 i_mode 字段相对于 inode 起始的偏移量（字节）
* 返回: OK 表示成功；其它值为错误码
***************************************************************************/
KModErr get_inode_i_mode_offset(uint32_t & offset);

/***************************************************************************
* 获取 inode 结构体中 i_opflags 字段的偏移量
* 参数: offset      输出参数，返回 i_opflags 字段相对于 inode 起始的偏移量（字节）
* 返回: OK 表示成功；其它值为错误码
***************************************************************************/
KModErr get_inode_i_opflags_offset(uint32_t & offset);

/***************************************************************************
* 获取 inode 结构体中 i_op 字段的偏移量
* 参数: offset      输出参数，返回 i_op 字段相对于 inode 起始的偏移量（字节）
* 返回: OK 表示成功；其它值为错误码
***************************************************************************/
KModErr get_inode_i_op_offset(uint32_t & offset);
