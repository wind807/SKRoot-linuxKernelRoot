...
X(ERR_MODULE_PID_CYCLE,) \
X(ERR_MODULE_ZYGOTE64_EMPTY,) \
X(ERR_MODULE_MUST_UNINSTALL,) \
X(ERR_MODULE_ASM,) \
...
X(ERR_MODULE_HOOK_IDEL_JUMP_ASM,) \
...
X(ERR_MODULE_MMAP,) \
X(ERR_MODULE_FCNTL,) \
X(ERR_MODULE_PHY_ADDR,) \
X(ERR_MODULE_OPEN_DEV_BLOCK,) \
