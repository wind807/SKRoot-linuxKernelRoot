...
#define ___MOD_NAME(val) \
    extern "C" inline void Error_Missing_SKRoot_Module_Name__Please_define_SKROOT_MODULE_NAME() { \
...
#define ___MOD_VERSION(val) \
    extern "C" inline void Error_Missing_SKRoot_Module_Version__Please_define_SKROOT_MODULE_VERSION() { \
...
#define ___MOD_DESC(val) \
    extern "C" inline void Error_Missing_SKRoot_Module_Descriptor__Please_define_SKROOT_MODULE_DESC() { \
...
#define ___MOD_AUTHOR(val) \
    extern "C" inline void Error_Missing_SKRoot_Module_Author__Please_define_SKROOT_MODULE_AUTHOR() { \
...
#define ___MOD_UUID32(val) \
    ...
    extern "C" inline void Error_Missing_SKRoot_Module_UUID32__Please_define_SKROOT_MODULE_UUID32() { \
