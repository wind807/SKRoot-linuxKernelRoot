...
X(ERR_MODULE_MEM_CALC,) \
X(ERR_MODULE_ALLOC_MEM,) \
X(ERR_MODULE_WRITE_MEM,) \
X(ERR_MODULE_READ_MEM,) \
X(ERR_MODULE_WRITE_MEM_X,) \
X(ERR_MODULE_ADDR_NOT_ALGIN4,) \
X(ERR_MODULE_DISABLE_RUN_FAKE_FLAG,) \
...
X(ERR_MODULE_EMPTY_AREA_NOT_FOUND,) \
X(ERR_MODULE_KERNEL_IDLE_NO_FOUND,) \
X(ERR_MODULE_KERNEL_IDLE_NOT_ENOUGH,) \
X(ERR_MODULE_KERNEL_IDLE_UNKNOW,) \
X(ERR_MODULE_STORAGE_PARSE,) \
X(ERR_MODULE_STORAGE_NO_MEM,) \
X(ERR_MODULE_STORAGE_NO_FOUND,) \
X(ERR_MODULE_STORAGE_BUG,) \
X(ERR_MODULE_BUFFER_TOO_SMALL,) \
X(ERR_MODULE_FOUND_CRED_GID,) \
X(ERR_MODULE_GET_RESUID,) \
X(ERR_MODULE_GET_RESGID,) \
X(ERR_MODULE_GET_FSUID,) \
X(ERR_MODULE_GET_FSGID,) \
X(ERR_MODULE_GET_CAPS,) \
X(ERR_MODULE_NO_ROOT,) \
X(ERR_MODULE_DLOPEN_FILE,) \
X(ERR_MODULE_DLBLOB,) \
X(ERR_MODULE_DLSYM,) \
...
X(ERR_MODULE_DEL_FOLDER,) \
X(ERR_MODULE_CREATE_DIR,) \
X(ERR_MODULE_CREATE_HIDE_FOLDER,) \
X(ERR_MODULE_GLOBAL_LIST_PARSE,) \
